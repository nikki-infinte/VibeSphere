...
VALUES
(1, 'Sunset Jazz Night', 'Live jazz with local artists', 'Music', NOW() + INTERVAL '9 day', 'Indiranagar Arena', 12.9784, 77.6408, 599.00, 120, 120, NULL, 43, NOW(), true),
...
INSERT INTO events (host_id, title, description, category, event_date, venue_name, latitude, longitude, price, capacity, tickets_available, image_url, views, created_at, is_active)
VALUES
(1 , 'Sonu Nigam Live Concert', 'Live concert by Sonu Nigam', 'Music', NOW() + INTERVAL '10 day', 'Mumbai Arena', 19.0760, 72.8777, 1000.00, 1000, 1000, NULL, 0, NOW(), true);